...
//Valdemar Wessing - Understanding HashSet in C#

namespace CS_Using_HashSet
{
    class Program
    {
        static string[] names = new string[] {"Tejas", "Mahesh", "Ramesh", "Ram", "GundaRam", "Sabnis", "Leena",
            ...
            "Leena", "Neema", "Sita",
            "Tejas", "Mahesh", "Ramesh", "Ram", "GundaRam", "Sabnis", "Teejas", "Maheesh", "Rameesh", "Rame", "GunedaRam",
            "Sabnis", "Leena", "Neema", "Sita", "Tejas",
            "Maheesh", "Rameeesh", "Ram", "GuendaRam", "Saebnhis",
            "Leeena", "Neeema", "Seita",
            "Teejas", "Maheesh", "Reamesh", "Ream", "GundeaRam", "Sabnis", "Tejas", "Mahesh", "Ramesh", "Ram", "GundaRam", "Sabnis", "Leena",
            "Neema", "Sita", "Tejas", "Mahesh", "Ramesh", "Ram",
            "GundaRam", "Sabnis", "Leena", "Neema", "Sita",
            "Tejas", "Mahesh", "Ramesh", "Ram", "GundaRam",
            "Sabnis", "Leena", "Neema", "Sita", "Tejas",
            ...
            "Maheesh", "Rameeesh", "Ram", "GuendaRam", "Saebnhis",
            "Leeena", "Neeema", "Seita",
            "Teejas", "Maheesh", "Reamesh", "Ream", "GundeaRam", "Sabnis" };
